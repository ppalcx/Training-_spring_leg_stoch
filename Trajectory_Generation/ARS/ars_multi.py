...
if __name__ == "__main__":  
  ...
  parser.add_argument('--obs_dim', help='observation_space', type=int, default=20)
  parser.add_argument('--directions', help='divising factor of total directions to use', type=int, default=2)
  parser.add_argument('--roc', help='radius of curvature', type=float, default=0.3)
  parser.add_argument('--scale', help='velocity Scale', type=float, default=1.0)
  ...
  register(id='Stoch2-v0',entry_point='envs.stoch2_gym_bullet_env_bezier:Stoch2Env', kwargs = {'gait' : args.gait, 'action_dim': args.action_dim, 'obs_dim': args.obs_dim,  'stairs': args.stairs, 'roc': args.roc, 'scale': args.scale })
  # #---------------------------------------------------------------------------------------------------------------------------------
